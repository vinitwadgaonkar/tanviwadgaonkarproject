...
def load_models():
    ...
    try:
        ...
        # Crop Recommendation
        crop_model_path = os.path.join(models_dir, 'crop_recommend_model.pkl')
        ...
        if os.path.exists(fert_model_path):
            ...
            with open(os.path.join(models_dir, 'soil_encoder.pkl'), 'rb') as f:
                encoders['soil'] = pickle.load(f)
            with open(os.path.join(models_dir, 'croptype_encoder.pkl'), 'rb') as f:
                encoders['croptype'] = pickle.load(f)
            with open(os.path.join(models_dir, 'fertilizer_encoder.pkl'), 'rb') as f:
        ...
        if os.path.exists(weather_model_path):
            ...
            with open(os.path.join(models_dir, 'rain_encoder.pkl'), 'rb') as f:
